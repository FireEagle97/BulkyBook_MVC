    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult GetAll(string status)
        {
            ...
            else
            {
                ...
                objOrderHeader = _unitOfWork.OrderHeader.GetAll(u => u.ApplicationUseId == userId, includeProperties: "ApplicationUser");
            }
            switch (status)
            {
                case "pending":
            ...
            return Json(new { data = objOrderHeader }, options);
        }
